/**
 * behavior/features/1.13.0/features/minecraft.growing_plant_feature.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:22.294Z
 */
 ...
 * @maxItems 2
 */
export type Blocks = [BlockceptionMinecraftBlockIdentifier, number];
/**
 * Plant body block.
 */
