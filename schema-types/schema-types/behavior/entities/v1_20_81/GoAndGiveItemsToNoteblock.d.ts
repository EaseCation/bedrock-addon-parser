/**
 * behavior/entities/format/behaviors/go_and_give_items_to_noteblock.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:44.823Z
 */
...
export interface GoAndGiveItemsToNoteblock {
   ...
   */
  throw_force?: number;
  throw_sound?: BlockceptionMinecraftGeneralSoundEvent;
  /**
