/**
 * behavior/entities/format/minecraft.entity.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:07.878Z
 */
 ...
 */
export type BreedItems = BreedItem[] | BlockceptionMinecraftItemIdentifier3;
/**
 * A minecraft item identifier.
 */
 ...
 */
export type Blocks = Blocks1[] | Blocks2;
/**
 ...
 * A minecraft item identifier.
 */
export type BribeItems1 = string;
/**
 ...
 */
export type RecoverAfterDriedOutEvent =
  | string
  | {
      /**
       * The event to fire.
 ...
 */
export type StoppedDryingOutEvent =
  | string
  | {
      /**
       * The event to fire.
 ...
 * A minecraft item identifier.
 */
export type Properties1 = string;
/**
 ...
 * UNDOCUMENTED.
 */
export type Value2 = [] | [number] | [number, number] | number | Range;
/**
 * Trigger to fire.
 */
 ...
 */
export type Block2 = BlockceptionMinecraftBlockIdentifier1 | BlockReference;
/**
 * A minecraft block identifier.
 */
 ...
 * Tells the pathfinder which blocks to avoid when creating a path.
 */
export type BlocksToAvoid = Block2[];
/**
 * Tells the pathfinder which blocks to avoid when creating a path.
 */
export type Block3 = BlockceptionMinecraftBlockIdentifier1 | BlockReference;
/**
 * Tells the pathfinder which blocks to avoid when creating a path.
 */
export type BlocksToAvoid1 = Block3[];
/**
 * Tells the pathfinder which blocks to avoid when creating a path.
 */
export type Block4 = BlockceptionMinecraftBlockIdentifier1 | BlockReference;
/**
 * Tells the pathfinder which blocks to avoid when creating a path.
 */
export type BlocksToAvoid2 = Block4[];
/**
 * Tells the pathfinder which blocks to avoid when creating a path.
 */
export type Block5 = BlockceptionMinecraftBlockIdentifier1 | BlockReference;
/**
 * Tells the pathfinder which blocks to avoid when creating a path.
 */
export type BlocksToAvoid3 = Block5[];
/**
 * Tells the pathfinder which blocks to avoid when creating a path.
 */
export type Block6 = BlockceptionMinecraftBlockIdentifier1 | BlockReference;
/**
 * Tells the pathfinder which blocks to avoid when creating a path.
 */
export type BlocksToAvoid4 = Block6[];
/**
 * Tells the pathfinder which blocks to avoid when creating a path.
 */
export type Block7 = BlockceptionMinecraftBlockIdentifier1 | BlockReference;
/**
 * Tells the pathfinder which blocks to avoid when creating a path.
 */
export type BlocksToAvoid5 = Block7[];
/**
 * Tells the pathfinder which blocks to avoid when creating a path.
 */
export type Block8 = BlockceptionMinecraftBlockIdentifier1 | BlockReference;
/**
 * Tells the pathfinder which blocks to avoid when creating a path.
 */
export type BlocksToAvoid6 = Block8[];
/**
 * UNDOCUMENTED.
 */
 ...
 */
export type Interval1 = string | number;
/**
 ...
 * A minecraft item identifier.
 */
export type BlockceptionMinecraftItemIdentifier4 = string;
/**
 * Minecraft behavior event.
 */
export type Event1 =
 ...
 * A minecraft item identifier.
 */
export type BlockceptionMinecraftItemIdentifier5 = string;
/**
 ...
 */
export type Interval2 = VectorOf2Items | number;
/**
 * Minecraft behavior event.
 */
export type Event14 =
 ...
 */
export type ForbiddenBlocks = BlockceptionMinecraftBlockIdentifier[];
/**
 * Blocks that the mob prefers jumping to.
 */
export type PreferredBlocks = BlockceptionMinecraftBlockIdentifier[];
/**
 ...
 */
export type TargetBlocks1 = unknown[];
/**
 ...
 * A minecraft block identifier.
 */
export type BlockceptionMinecraftBlockIdentifier3 = string;
/**
 * Block types to move to.
 */
export type TargetBlocks2 = BlockceptionMinecraftBlockIdentifier3[];
/**
 ...
 * A minecraft item identifier.
 */
export type ExcludedItem = string;
/**
 ...
 */
export type LookTime5 = number | [] | [number] | [number, number];
/**
 ...
 */
export type Items2 = Item3[] | BlockceptionMinecraftItemIdentifier;
/**
 * A minecraft item identifier.
 */
 ...
 */
export type Items3 = BlockceptionMinecraftItemIdentifier[];
/**
...
export interface Item1 {
   ...
   */
  craft_into?: string;
  item?: BlockceptionMinecraftItemIdentifier4;
  /**
...
export interface AutoRejectItems1 {
  item?: BlockceptionMinecraftItemIdentifier5;
  [k: string]: unknown;
}
/**
 * The list of items that this entity dislikes and will cause it to get angry if used while untamed.
...
export interface TargetNearbySensor {
   ...
   */
  inside_range?: number;
  on_inside_range?: Event5;
  on_outside_range?: Event6;
  on_vision_lost_inside_range?: Event7;
  /**
...
export interface AdmireItem1 {
  ...
  on_admire_item_start?: Event10;
  on_admire_item_stop?: Event11;
...
export interface CelebrateSurvive {
   ...
   */
  duration?: number;
  on_celebration_end_event?: Event13;
}
/**
...
export interface MoveToBlock {
  ...
  target_block_filters?: Filters29;
  /**
...
export interface Nap {
  ...
  can_nap_filters?: Filters30;
  wake_mob_exceptions?: Filters31;
}
/**
