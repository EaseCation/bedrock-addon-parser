/**
 * resource/ui/elements/properties/slider_collection_name.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:46.291Z
 */

/**
 * The name of the collection that the slider is in.
 */
export type SliderCollectionName = string | ((string | VariableReference) & string);
/**
