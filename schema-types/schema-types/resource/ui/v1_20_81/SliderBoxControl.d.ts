/**
 * resource/ui/elements/properties/slider_box_control.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:46.292Z
 */

/**
 * The control that will be used for the slider box.
 */
export type SliderBoxControl = 'slider_box' | (string | VariableReference);
/**
