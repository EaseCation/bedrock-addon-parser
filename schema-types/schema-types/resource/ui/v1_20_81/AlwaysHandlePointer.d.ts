/**
 * resource/ui/elements/properties/always_handle_pointer.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:46.481Z
 */

/**
 * If true, the element will always handle the pointer.
 */
export type AlwaysHandlePointer = boolean | ((string | VariableReference) & string);
/**
