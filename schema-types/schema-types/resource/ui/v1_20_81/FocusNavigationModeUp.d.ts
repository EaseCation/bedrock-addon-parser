/**
 * resource/ui/elements/properties/focus_navigation_mode_up.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:46.396Z
 */

/**
 * The focus navigation mode that will be used when navigating up.
 */
export type FocusNavigationModeUp = NavigationMode | (string | VariableReference);
/**
