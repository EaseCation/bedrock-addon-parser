/**
 * resource/ui/elements/properties/use_last_focus.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:46.235Z
 */

/**
 * If true, the element will use the last focus.
 */
export type UseLastFocus = boolean | ((string | VariableReference) & string);
/**
