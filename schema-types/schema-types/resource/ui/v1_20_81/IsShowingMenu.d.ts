/**
 * resource/ui/elements/properties/is_showing_menu.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:46.356Z
 */

/**
 * If true, the element will be showing the menu.
 */
export type IsShowingMenu = boolean | ((string | VariableReference) & string);
/**
