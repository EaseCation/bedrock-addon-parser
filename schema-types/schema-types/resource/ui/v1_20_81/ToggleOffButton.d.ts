/**
 * resource/ui/elements/properties/toggle_off_button.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:46.248Z
 */

/**
 * The button that will toggle the element.
 */
export type ToggleOffButton = string | ((string | VariableReference) & string);
/**
