/**
 * resource/ui/elements/properties/render_only_when_topmost.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:46.319Z
 */

/**
 * If true, the element will only be rendered when it is the topmost element.
 */
export type RenderOnlyWhenTopmost = boolean | ((string | VariableReference) & string);
/**
