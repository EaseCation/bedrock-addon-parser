/**
 * resource/ui/elements/properties/scroll_view_port.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:46.303Z
 */

/**
 * The view port that the element will be scrolled in.
 */
export type ScrollViewPort = string | ((string | VariableReference) & string);
/**
