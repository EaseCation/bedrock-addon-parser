/**
 * resource/ui/elements/properties/send_telemetry.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:46.297Z
 */

/**
 * If true, the element will send telemetry.
 */
export type SendTelemetry = boolean | ((string | VariableReference) & string);
/**
