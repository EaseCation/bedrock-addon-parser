/**
 * resource/ui/elements/properties/enabled_newline.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:46.418Z
 */

/**
 * If true, the element will be enabled when a new line is created.
 */
export type EnabledNewline = boolean | ((string | VariableReference) & string);
/**
