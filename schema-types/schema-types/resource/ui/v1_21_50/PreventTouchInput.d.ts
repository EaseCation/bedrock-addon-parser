/**
 * resource/ui/elements/properties/prevent_touch_input.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.695Z
 */

/**
 * If true, touch input will be prevented from passing through this element.
 */
export type PreventTouchInput = boolean | ((string | VariableReference) & string);
/**
