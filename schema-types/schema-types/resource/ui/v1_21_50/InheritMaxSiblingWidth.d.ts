/**
 * resource/ui/elements/properties/inherit_max_sibling_width.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.724Z
 */

/**
 * If true, the element will inherit the maximum width of its siblings.
 */
export type InheritMaxSiblingWidth = boolean | ((string | VariableReference) & string);
/**
