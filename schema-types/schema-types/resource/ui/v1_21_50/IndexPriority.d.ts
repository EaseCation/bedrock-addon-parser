/**
 * resource/ui/elements/properties/tts/index_priority.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.852Z
 */

/**
 * The priority of the TTS index.
 */
export type TTSIndexPriority = number | ((string | VariableReference) & string);
/**
