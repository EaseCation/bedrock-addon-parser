/**
 * resource/ui/elements/properties/clip_direction.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.808Z
 */

/**
 * The direction that the element will be clipped in.
 */
export type ClipDirection = ('left' | 'right' | 'top' | 'bottom') | (string | VariableReference);
/**
