/**
 * resource/ui/elements/properties/tts/control_type_order_priority.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.856Z
 */

/**
 * The priority of the TTS control type order.
 */
export type TTSControlTypeOrderPriority = number | ((string | VariableReference) & string);
/**
