/**
 * resource/ui/elements/properties/orientation.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.700Z
 */

/**
 * The orientation of the element.
 */
export type Orientation = ('horizontal' | 'vertical') | (string | VariableReference);
/**
