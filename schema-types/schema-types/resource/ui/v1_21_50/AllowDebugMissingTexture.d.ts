/**
 * resource/ui/elements/properties/allow_debug_missing_texture.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.839Z
 */

/**
 * If true, the element will show the black and purple placeholder texture if the referenced image is not found.
 */
export type AllowDebugMissingTexture = boolean | ((string | VariableReference) & string);
/**
