/**
 * resource/ui/elements/properties/unchecked_locked_hover_control.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.611Z
 */

/**
 * The control that will be unchecked when locked and hovered.
 */
export type UncheckedLockedHoverControl = 'unchecked' | (string | VariableReference);
/**
