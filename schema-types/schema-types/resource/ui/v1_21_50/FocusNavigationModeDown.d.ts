/**
 * resource/ui/elements/properties/focus_navigation_mode_down.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.759Z
 */

/**
 * The focus navigation mode that will be used when navigating down.
 */
export type FocusNavigationModeDown = NavigationMode | (string | VariableReference);
/**
