/**
 * resource/ui/elements/properties/always_handle_scrolling.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.834Z
 */

/**
 * If true, the element will always handle scrolling.
 */
export type AlwaysHandleScrolling = boolean | ((string | VariableReference) & string);
/**
