/**
 * resource/ui/elements/properties/allow_clipping.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.840Z
 */

/**
 * If true, the element will allow clipping.
 */
export type AllowClipping = boolean | ((string | VariableReference) & string);
/**
