/**
 * resource/ui/elements/properties/scrollbar_touch_button.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.667Z
 */

/**
 * The button that will be used for the scrollbar touch.
 */
export type ScrollbarTouchButton = string | VariableReference;
/**
