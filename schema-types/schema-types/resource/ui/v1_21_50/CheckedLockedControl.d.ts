/**
 * resource/ui/elements/properties/checked_locked_control.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.810Z
 */

/**
 * The control that will be checked when locked.
 */
export type CheckedLockedControl = 'checked' | (string | VariableReference);
/**
