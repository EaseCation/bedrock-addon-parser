/**
 * resource/ui/elements/properties/slider_deselected_button.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:37:03.465Z
 */

/**
 * The button that will be used for the slider deselected.
 */
export type SliderDeselectedButton = string | VariableReference;
/**
