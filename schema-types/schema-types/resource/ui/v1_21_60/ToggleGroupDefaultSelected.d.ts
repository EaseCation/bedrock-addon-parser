/**
 * resource/ui/elements/properties/toggle_group_default_selected.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:37:03.432Z
 */

/**
 * The default selected toggle of the toggle group.
 */
export type ToggleGroupDefaultSelected = string | ((string | VariableReference) & string);
/**
