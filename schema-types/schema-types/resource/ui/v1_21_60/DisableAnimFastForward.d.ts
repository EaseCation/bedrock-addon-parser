/**
 * resource/ui/elements/properties/disable_anim_fast_forward.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:37:03.613Z
 */

/**
 * If true, the animation will not be fast forwarded.
 */
export type DisableAnimFastForward = boolean | ((string | VariableReference) & string);
/**
