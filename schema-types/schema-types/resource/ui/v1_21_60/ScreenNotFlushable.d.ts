/**
 * resource/ui/elements/properties/screen_not_flushable.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:37:03.486Z
 */

/**
 * If true, the screen will not be flushed when the element is added.
 */
export type ScreenNotFlushable = boolean | ((string | VariableReference) & string);
/**
