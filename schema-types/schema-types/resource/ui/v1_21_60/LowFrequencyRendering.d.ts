/**
 * resource/ui/elements/properties/low_frequency_rendering.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:37:03.525Z
 */

/**
 * If true, the element will be rendered at a lower frequency.
 */
export type LowFrequencyRendering = boolean | ((string | VariableReference) & string);
/**
