/**
 * resource/ui/elements/properties/toggle_grid_collection_name.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:37:03.434Z
 */

/**
 * The name of the collection that the toggle grid is in.
 */
export type ToggleGridCollectionName = string | ((string | VariableReference) & string);
/**
