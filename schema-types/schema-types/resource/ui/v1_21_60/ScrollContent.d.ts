/**
 * resource/ui/elements/properties/scroll_content.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:37:03.484Z
 */

/**
 * The content that will be scrolled.
 */
export type ScrollContent = string | ((string | VariableReference) & string);
/**
