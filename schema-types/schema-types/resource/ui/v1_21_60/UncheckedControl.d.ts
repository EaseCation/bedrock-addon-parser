/**
 * resource/ui/elements/properties/unchecked_control.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:37:03.422Z
 */

/**
 * The control that will be unchecked.
 */
export type UncheckedControl = 'unchecked' | (string | VariableReference);
/**
