/**
 * resource/ui/elements/properties/jump_to_bottom_on_update.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:37:03.535Z
 */

/**
 * If true, the element will jump to the bottom when updated.
 */
export type JumpToBottomOnUpdate = boolean | ((string | VariableReference) & string);
/**
