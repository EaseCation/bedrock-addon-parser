 ...
 */
export type WidthModifier2 = string | number;
/**
 ...
 * @minItems 1
 */
export type PlacesBlock4 = [Block1, ...Block1[]];
/**
 * Reference to the block to be placed.
 */
export type Block1 = [] | [Block2] | [Block2, number];
/**
 * A minecraft block identifier.
 */
 ...
 * UNDOCUMENTED.
 */
export type Bottom = Block3 | Block4[];
/**
 * UNDOCUMENTED.
 */
export type North = Block3 | Block4[];
/**
 * UNDOCUMENTED.
 */
export type South = Block3 | Block4[];
/**
 * UNDOCUMENTED.
 */
export type East = Block3 | Block4[];
/**
 * UNDOCUMENTED.
 */
export type West = Block3 | Block4[];
/**
 * UNDOCUMENTED.
 */
export type All = Block3 | Block4[];
/**
 * UNDOCUMENTED.
 */
export type Sides = Block3 | Block4[];
/**
 * UNDOCUMENTED.
 */
export type Diagonal = Block3 | Block4[];
/**
 * UNDOCUMENTED.
 */
export type Top1 = Block3 | Block4[];
/**
 * UNDOCUMENTED.
 */
export type Bottom1 = Block3 | Block4[];
/**
 * UNDOCUMENTED.
 */
export type North1 = Block3 | Block4[];
/**
 * UNDOCUMENTED.
 */
export type South1 = Block3 | Block4[];
/**
 * UNDOCUMENTED.
 */
export type East1 = Block3 | Block4[];
/**
 * UNDOCUMENTED.
 */
export type West1 = Block3 | Block4[];
/**
 * UNDOCUMENTED.
 */
export type All1 = Block3 | Block4[];
/**
 * UNDOCUMENTED.
 */
export type Sides1 = Block3 | Block4[];
/**
 * UNDOCUMENTED.
 */
export type Diagonal1 = Block3 | Block4[];
/**
 * A minecraft block identifier.
 */
 ...
 * A list of blocks that may be replaced during placement. Omit this field to allow any block to be replaced.
 */
export type MayReplace1 = Block5[];
/**
 ...
 */
export type BlockAllowlist = Block6[];
/**
 * A minecraft block identifier.
 */
export type Block7 = string;
/**
 * List of blocks the owning structure is allowed to intersect with.
 */
export type BlockWhitelist = Block7[];
/**
 * Named reference of feature to be placed.
 */
export type FeatureToPlace = string;
export type BaseBlock = BlockceptionMinecraftBlockIdentifier | Block8[];
/**
 * A minecraft block identifier.
 */
export type Block8 = string;
/**
 ...
 * How many blocks to increase the cave radius by, from the center point of the cave.
 */
export type WidthModifier3 = string | number;
/**
 * The scaling in y
 *
 * @minItems 2
...
export interface SingleBlockFeature {
  description: Description;
  places_block: PlacesBlock3 | PlacesBlock4;
  /**
