/**
 * resource/ui/elements/properties/scroll_box_and_track_panel.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:46.307Z
 */

/**
 * The panel that will be used for the scroll box and track.
 */
export type ScrollBoxAndTrackPanel = string | ((string | VariableReference) & string);
/**
