/**
 * resource/ui/elements/properties/slider_small_increase_button.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:46.279Z
 */

/**
 * The button that will be used for the slider small decrease.
 */
export type SliderSmallIncreaseButton = string | VariableReference;
/**
