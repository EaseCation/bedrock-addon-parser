/**
 * resource/ui/elements/properties/tts/value_changed.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:46.493Z
 */

/**
 * If true, the TTS value will change.
 */
export type TTSValueChanged = boolean | ((string | VariableReference) & string);
/**
