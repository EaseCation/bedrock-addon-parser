/**
 * resource/ui/elements/properties/force_texture_reload.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:46.386Z
 */

/**
 * If true, the texture will be reloaded.
 */
export type ForceTextureReload = boolean | ((string | VariableReference) & string);
/**
