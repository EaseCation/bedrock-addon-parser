/**
 * resource/ui/elements/properties/tts/control_header.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:46.508Z
 */

/**
 * The header of the TTS control.
 */
export type TTSControlHeader = string | ((string | VariableReference) & string);
/**
