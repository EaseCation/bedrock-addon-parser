/**
 * resource/ui/elements/properties/collection_index.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:46.446Z
 */

/**
 * The index of the collection that the element is in.
 */
export type CollectionIndex = number | ((string | VariableReference) & string);
/**
