/**
 * resource/ui/elements/properties/tts/toggle_off.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:46.496Z
 */

/**
 * If true, the TTS will toggle off.
 */
export type TTSToggleOff = boolean | ((string | VariableReference) & string);
/**
