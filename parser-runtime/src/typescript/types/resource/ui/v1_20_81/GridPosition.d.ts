/**
 * resource/ui/elements/properties/grid_position.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:46.375Z
 */

/**
 * The position of the grid.
 */
export type GridPosition = ((string | VariableReference) & string) | [] | [Width] | [Width, Height];
/**
