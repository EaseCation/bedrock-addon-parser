/**
 * resource/ui/elements/properties/tts/ignore_count.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:46.505Z
 */

/**
 * The number of TTS ignores.
 */
export type TTSIgnoreCount = number | ((string | VariableReference) & string);
/**
