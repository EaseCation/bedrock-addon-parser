/**
 * resource/ui/elements/properties/tts/value_order_priority.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:37:03.671Z
 */

/**
 * The priority of the TTS value order.
 */
export type TTSValueOrderPriority = number | ((string | VariableReference) & string);
/**
