/**
 * resource/ui/elements/properties/consume_hover_events.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:37:03.625Z
 */

/**
 * If true, the element will consume hover events.
 */
export type ConsumeHoverEvents = boolean | ((string | VariableReference) & string);
/**
