/**
 * resource/ui/elements/properties/default_control.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:37:03.617Z
 */

/**
 * The default control that will be focused.
 */
export type DefaultControl = string | ((string | VariableReference) & string);
/**
