/**
 * resource/ui/elements/properties/max_size.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:37:03.522Z
 */

/**
 * The maximum size of the element.
 */
export type MaxSize = ((string | VariableReference) & string) | [] | [Width] | [Width, Height];
/**
