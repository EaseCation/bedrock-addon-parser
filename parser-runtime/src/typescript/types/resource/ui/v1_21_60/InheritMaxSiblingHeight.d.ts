/**
 * resource/ui/elements/properties/inherit_max_sibling_height.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:37:03.543Z
 */

/**
 * If true, the element will inherit the maximum height of its siblings.
 */
export type InheritMaxSiblingHeight = boolean | ((string | VariableReference) & string);
/**
