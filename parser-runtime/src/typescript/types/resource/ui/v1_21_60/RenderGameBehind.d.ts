/**
 * resource/ui/elements/properties/render_game_behind.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:37:03.497Z
 */

/**
 * If true, the game will be rendered behind the element.
 */
export type RenderGameBehind = boolean | ((string | VariableReference) & string);
/**
