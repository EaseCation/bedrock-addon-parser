/**
 * resource/ui/elements/properties/focus_identifier.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:37:03.584Z
 */

/**
 * The identifier of the element that will be focused.
 */
export type FocusIdentifier = string | ((string | VariableReference) & string);
/**
