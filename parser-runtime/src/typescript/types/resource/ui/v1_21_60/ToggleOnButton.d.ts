/**
 * resource/ui/elements/properties/toggle_on_button.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:37:03.427Z
 */

/**
 * The button that will toggle the element.
 */
export type ToggleOnButton = string | ((string | VariableReference) & string);
/**
