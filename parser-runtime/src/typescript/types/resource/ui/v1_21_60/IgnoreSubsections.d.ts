/**
 * resource/ui/elements/properties/tts/ignore_subsections.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:37:03.685Z
 */

/**
 * If true, the element will ignore subsections.
 */
export type TTSIgnoreSubsections = boolean | ((string | VariableReference) & string);
/**
