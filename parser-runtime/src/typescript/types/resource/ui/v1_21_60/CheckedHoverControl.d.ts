/**
 * resource/ui/elements/properties/checked_hover_control.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:37:03.638Z
 */

/**
 * The control that will be checked when hovered.
 */
export type CheckedHoverControl = 'checked' | (string | VariableReference);
/**
