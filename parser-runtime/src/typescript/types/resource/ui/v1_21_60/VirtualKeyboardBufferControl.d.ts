/**
 * resource/ui/elements/properties/virtual_keyboard_buffer_control.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:37:03.402Z
 */

/**
 * The control that will be used for the virtual keyboard buffer.
 */
export type VirtualKeyboardBufferControl = string | ((string | VariableReference) & string);
/**
