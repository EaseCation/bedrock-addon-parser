/**
 * resource/ui/elements/properties/reset_on_focus_lost.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.680Z
 */

/**
 * If true, the element will be reset when focus is lost.
 */
export type ResetOnFocusLost = boolean | ((string | VariableReference) & string);
/**
