/**
 * resource/ui/elements/properties/radio_toggle_group.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.685Z
 */

/**
 * The radio toggle group that the element is in.
 */
export type RadioToggleGroup = string | ((string | VariableReference) & string);
/**
