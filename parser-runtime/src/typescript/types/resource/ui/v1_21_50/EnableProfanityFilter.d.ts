/**
 * resource/ui/elements/properties/enable_profanity_filter.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.780Z
 */

/**
 * If true, the element will enable the profanity filter.
 */
export type EnableProfanityFilter = boolean | ((string | VariableReference) & string);
/**
