/**
 * resource/ui/elements/properties/use_anchored_offset.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.610Z
 */

/**
 * If true, the element will use the anchored offset.
 */
export type UseAnchoredOffset = boolean | ((string | VariableReference) & string);
/**
