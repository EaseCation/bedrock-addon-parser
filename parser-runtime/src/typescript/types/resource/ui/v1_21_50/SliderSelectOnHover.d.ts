/**
 * resource/ui/elements/properties/slider_select_on_hover.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.650Z
 */

/**
 * If true, the slider will select on hover.
 */
export type SliderSelectOnHover = boolean | ((string | VariableReference) & string);
/**
