/**
 * resource/ui/elements/properties/progress_control.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.693Z
 */

/**
 * The control that will be used for the progress.
 */
export type ProgressControl = string | ((string | VariableReference) & string);
/**
