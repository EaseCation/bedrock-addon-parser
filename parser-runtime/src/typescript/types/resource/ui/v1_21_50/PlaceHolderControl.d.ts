/**
 * resource/ui/elements/properties/place_holder_control.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.699Z
 */

/**
 * The control that will be used for the place holder.
 */
export type PlaceHolderControl = string | ((string | VariableReference) & string);
/**
