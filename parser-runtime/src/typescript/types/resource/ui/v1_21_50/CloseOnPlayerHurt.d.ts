/**
 * resource/ui/elements/properties/close_on_player_hurt.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.805Z
 */

/**
 * If true, the element will close when the player is hurt.
 */
export type CloseOnPlayerHurt = boolean | ((string | VariableReference) & string);
/**
