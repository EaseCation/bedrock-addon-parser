/**
 * resource/ui/elements/properties/always_listen_to_input.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.833Z
 */

/**
 * If true, the element will always listen to input.
 */
export type AlwaysListenToInput = boolean | ((string | VariableReference) & string);
/**
