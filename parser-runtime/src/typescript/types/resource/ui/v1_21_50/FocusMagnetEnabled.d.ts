/**
 * resource/ui/elements/properties/focus_magnet_enabled.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.760Z
 */

/**
 * If true, the element will be focus magnet enabled.
 */
export type FocusMagnetEnabled = boolean | ((string | VariableReference) & string);
/**
