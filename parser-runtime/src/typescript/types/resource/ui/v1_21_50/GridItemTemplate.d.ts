/**
 * resource/ui/elements/properties/grid_item_template.json 的类型定义
 *
 * 此文件由 schema-types-ts 自动生成
 * 请勿手动修改此文件
 *
 * 生成时间: 2025-11-08T05:36:54.739Z
 */

/**
 * The template that will be used for the grid item.
 */
export type GridItemTemplate = string | ((string | VariableReference) & string);
/**
